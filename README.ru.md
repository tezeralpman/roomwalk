...
в десять кредитов вместо семидесяти.
...
Две вещи, которые решают результат:
...
**Не ставьте `timeline`.** Проход останавливается, потому что он ходит по местам.
Разборка — один жест, и пауза посреди него читается как зависание.
